...
static const _FandB_type_support_symbol_names_t _FandB_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, geneta_slam_ros2_pkg, msg, FandB)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, geneta_slam_ros2_pkg, msg, FandB)),
  }
};
...
{
  return &::geneta_slam_ros2_pkg::msg::rosidl_typesupport_cpp::FandB_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, geneta_slam_ros2_pkg, msg, FandB)() {
  return get_message_type_support_handle<geneta_slam_ros2_pkg::msg::FandB>();
}
