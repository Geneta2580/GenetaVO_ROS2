...
bool geneta_slam_ros2_pkg__msg__fand_b__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geneta_slam_ros2_pkg.msg._fand_b.FandB", full_classname_dest, 38) == 0);
  }
  geneta_slam_ros2_pkg__msg__FandB * ros_message = _ros_message;
  {  // header
  ...
  {  // v
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'v'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // landmark_ids
    PyObject * field = PyObject_GetAttrString(_pymsg, "landmark_ids");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->landmark_ids.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'landmark_ids'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of FandB */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("geneta_slam_ros2_pkg.msg._fand_b");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FandB");
  ...
  {  // u
    ...
    if (ros_message->u.size > 0) {
      ...
      float * src = &(ros_message->u.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->u.size * sizeof(float));
      assert(data != NULL);
  ...
  {  // v
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "v");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->v.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->v.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->v.size * sizeof(float));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // landmark_ids
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "landmark_ids");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->landmark_ids.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->landmark_ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->landmark_ids.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
